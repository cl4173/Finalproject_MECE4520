...
def Regression(n_trail:int,p_c:float,Itol:float,r_type:int,r_solver:str,m_iter:int,l1_ratio:float,data):
    ...
    for i in range(n_trail):
        ...
        #Train and validate
        I_data_x=I_data.drop(["Diabetes_012"],axis=1) # Get X
        I_data_y=I_data["Diabetes_012"]
        ...
        tol=Itol,C=I_p_c,max_iter=m_iter,l1_ratio=I_l1_ratio,n_jobs=-1,multi_class="multinomial")                          # Logistic regression
