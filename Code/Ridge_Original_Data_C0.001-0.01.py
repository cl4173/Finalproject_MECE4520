...
P_C=0.001        # Set penalty C start point
P_C_step=0.001   # Set penalty C increase step
R_solver="sag"# Define regression solver，newton-cg’, ‘lbfgs’, ‘liblinear’, ‘sag’, ‘saga’
R_type_A=1     # Define regression type, 0-normal, 1-ridge, 2-lasso, 3-elastic net
