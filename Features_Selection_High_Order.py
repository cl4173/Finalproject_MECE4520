...
for o in range(2,Order+2):
    ...
    H_model=sklearn.linear_model.LogisticRegression(penalty='none',dual=False,solver='sag',max_iter=8000,n_jobs=-1) # Logistic regression
